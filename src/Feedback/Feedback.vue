      ...
      <div class="main_workspace" v-if="authorised">
        ...
        <div class="centre_column">
          ...
          <div class="displayQuery" style="height:60vh;    background-color: Khaki;">
            ...
            <div class="tooltips">
              Please see the instruction here.
              <span class="tooltip_info" style="visibility: initial;">This feature can provide student users with
                information about what is correct and incorrect in the current answer</span>
            </div>
            <div class="container">
          ...
          <div class="displayQuery" style="height:40vh;    background-color: #F0E9FF;">
            ...
            <div class="tooltips">
              Please see the instruction here.
              <span class="tooltip_info" style="visibility: initial;">This is feedback section,where students can view
                text feedback provided by the teacher</span>
            </div>
