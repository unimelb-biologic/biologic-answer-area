  ...
  methods: {
    ...
    dropIsPermissible(connectorBeingDroppedOn, connectorBeingDropped) {
      ...
      if (connectorBeingDroppedOn === connectorBeingDropped) {
        ...
        const inTree = this.connector1IsInTreeOfconnector2(
          connectorBeingDroppedOn,
          connectorBeingDropped
        );
    ...
    handleAConnectorDrop(info) {
      ...
      if (
        ...
        !this.dropIsPermissible(connectorID, droppedConnectorID)
      ) {
    ...
    handleBConnectorDrop(info) {
      ...
      if (
        droppedConnectorID !== undefined &&
        !this.dropIsPermissible(connectorID, data.connectorID)
      ) {
        console.log("ERROR CIRCULAR REFERENCE");
        return;
      }
    ...
    handleNewConnectorDroppedOnSomething(info) {
      ...
      if (droppedOnConnectorID == undefined) {
        wasStatement = true;
        console.log(
          "AnswerArea::handleNewConnectorDroppedOnSomething     old statement id",
          droppedOnStatementID,
          "new connector ID",
          droppedConnectorID
        );
        ...
        wasStatement = false;
        console.log(
          "AnswerArea::handleNewConnectorDroppedOnSomething     old connector id",
      ...
      if (droppedConnectorID === undefined) {
        ...
        this.allConnectors[droppedConnectorID]["leftID"] = wasStatement
          ? droppedOnStatementID
          : droppedOnConnectorID;
        this.allConnectors[droppedConnectorID]["leftType"] = wasStatement
          ? "statement"
          : "connector";
        this.allConnectors[droppedConnectorID]["leftContent"] = undefined;
        this.allConnectors[droppedConnectorID]["leftStatementIdentifier"] =
        ...
        if (wasStatement) {
          ...
          this.allStatements[droppedOnStatementID]["parent"] =
            droppedConnectorID;
          if (parentConnID === -1) {
          ...
          this.allConnectors[droppedOnConnectorID]["parent"] =
            droppedConnectorID;
          if (parentConnID === -1) {
            ...
            this.rootConnectorID_set.add(droppedConnectorID);
            this.allConnectors[droppedConnectorID]["top"] =
              this.allConnectors[droppedOnConnectorID]["top"];
            this.allConnectors[droppedConnectorID]["left"] =
